...
<x-app-layout title="Tambah Transaksi">
    ...
    <form action="{{ route('transaksi.store') }}" enctype="multipart/form-data" method="post"
            ...
            <div class="space-y-2">
                ...
                <div class="">
                    ...
                    <template x-for="(item, index) in items" :key="index">
                        <div
                            class="flex items-end justify-between gap-2 pt-4 pb-4 border-b border-black first:pt-0 last:border-b-0 ">
                            <div class="grid items-center w-full grid-cols-5 gap-4 ">
                                @if (config('app.itr')<1) {{-- ITERASI 1 : Menambahkan kolom note pada produk yang
                                    dipilih --}} <div class="col-span-4 lg:col-span-4">
        ...
        <div class="sticky w-full space-y-4 md:w-1/3" x-data="{ status: 'selesai', diskon: 0, lunas: 1 }">
            ...
            {{-- ITERASI 2 => MENAMBAHKAN KOLOM DP DAN STATUS PEMBAYARAN --}}
